#!/usr/bin/env python3
"""
Test different percentiles including out5.png
"""
...
test_cases = [
    ...
    ('images/out5.png', 6)  # NEW
]

print("=" * 80)
print("TESTING DIFFERENT PERCENTILES (INCLUDING out5.png)")
print("=" * 80)

for percentile in [85, 87, 88, 89, 90]:
    print(f"\n{'='*80}")
    ...
    for img_path, expected_lines in test_cases:
        ...
        print(f"  {status} {img_path:25s}: {lines_count} lines (expected {expected_lines}) [threshold: {gap_threshold:.1f}px]")
