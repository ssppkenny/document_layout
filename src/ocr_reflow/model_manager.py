...
Directory structure:
    models/
    ├── doclayout_yolo_docstructbench_imgsz1024.pt    # Layout detection (doclayout-yolo)
    ├── yolo26n_doc_layout.pt                          # Ensemble layout detection (YOLOv26-nano)
    ├── layoutlmv3_toc/                                 # TOC page detection (fine-tuned LayoutLMv3)
    │   ├── config.json
    │   ├── model.safetensors
    │   └── ...
    └── doctr/                                          # Word-level text detection (auto-cached)
